...
public class RiceAndShineAdapter extends RecyclerView.Adapter<RiceAndShineAdapter.MyViewHolder> {

    List<RiceAndShineClass> list;
    String getAddress = "";
    ...
    public RiceAndShineAdapter(Context context , List<RiceAndShineClass> list) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        RiceAndShineClass modelObject = list.get(position);
