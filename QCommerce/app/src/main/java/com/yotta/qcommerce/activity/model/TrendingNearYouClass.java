...
public class TrendingNearYouClass {

    Integer productImage;
    String productName,productStrikePrice,productPrice,productQuantity;

    public TrendingNearYouClass(Integer productImage, String productName, String productStrikePrice, String productPrice, String productQuantity) {
