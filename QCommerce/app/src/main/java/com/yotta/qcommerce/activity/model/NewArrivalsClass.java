...
public class NewArrivalsClass {

    Integer productImage;
    String productName,productStrikePrice,productPrice,productQuantity;

    public NewArrivalsClass(Integer productImage, String productName, String productStrikePrice, String productPrice, String productQuantity) {
