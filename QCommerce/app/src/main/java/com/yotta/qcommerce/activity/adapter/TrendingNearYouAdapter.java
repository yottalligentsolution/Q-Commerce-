...
public class TrendingNearYouAdapter extends RecyclerView.Adapter<TrendingNearYouAdapter.MyViewHolder> {

    List<TrendingNearYouClass> list;
    String getAddress = "";
    ...
    public TrendingNearYouAdapter(Context context , List<TrendingNearYouClass> list) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        TrendingNearYouClass modelObject = list.get(position);
